...
> "You must show your working clearly; no marks will be given for unsupported answers from a calculator."

It goes further than quadratics. One report spells out the full list of where unsupported answers fail:

> "Examiners are unable to give credit when ... quadratic equation solutions, definite integration results, gradients, simultaneous equation solutions, intersection points and sums of series arrive from little or no working. Even when these results are correct they are not acceptable."
...
> "It was very rare to see an answer confusing degrees and radians gain any credit."

The second pattern is reading speed. Students find one quantity and stop, missing that the question wanted two:

> "Some candidates stopped after finding only the perimeter or area."
...
> "Those few who did not square y were then faced with an integral they could not find."

A close cousin is computing the wrong thing entirely, area instead of volume:

> "Other candidates found the area under the curve rather than the volume of revolution and they are to be reminded to read each question carefully [...]"
...
> "the negative alternative was often ignored."
...
> "Use of the chain rule to connect the given and required rate of change was seen very occasionally."
...
> "A significant number of candidates did not realise that the substitution of individual values into the gradient ... was not sufficient evidence to conclude that the gradient was always positive."
...
3. **Read the whole question, and draw the diagram.** Examiners explicitly recommend sketches, especially for circle and coordinate geometry questions: "Using a diagram may well have avoided this waste and should always be encouraged [...]"
...
Instead of handing you another stack of PDFs, ExamPilot maps which 9709 Pure 1 topics are leaking your marks and builds a revision plan around active recall and spaced repetition, so the fix sticks. You can explore the full topic breakdown in our [Cambridge 9709 Pure 1 revision guide](/cambridge/9709/pure-1).
...
Cambridge International publishes examiner reports for every exam session on its [official 9709 past papers pages](https://www.cambridgeinternational.org/programmes-and-qualifications/cambridge-international-as-and-a-level-mathematics-9709/past-papers/), alongside the question papers and mark schemes. They're free to access. Read the most recent reports for Paper 12 and Paper 13 before your final revision weeks, because they tell you exactly which mistakes examiners are seeing most often.
